...
local function lsp_keymaps(client, bufnr)
	...
	keymap(bufnr, "n", "ld", "<cmd>Lspsaga peek_definition<CR>", opts)
	keymap(bufnr, "n", "gtd", "<cmd>Lspsaga goto_type_definition<CR>", opts)
	keymap(bufnr, "n", "ltd", "<cmd>Lspsaga peek_type_definition<CR>", opts)
	...
	keymap(bufnr, "n", "gl", "<cmd>Lspsaga show_workspace_diagnostics ++float<CR>", opts)
	...
	keymap(bufnr, "n", "<leader>lq", "<cmd>Lspsaga show_workspace_diagnostics ++normal<CR>", opts)
	-- add ++unfocus flag to not jump to diagnostics window
	keymap(bufnr, "n", "<leader>ic", "<cmd>Lspsaga incoming_calls<CR>", opts)
	keymap(bufnr, "n", "<leader>oc", "<cmd>Lspsaga outgoing_calls<CR>", opts)
